 ...
 const handleFileChange = (file) => {
  ...
  useEffect(() => {
    ...
    if (sendData) {
      ...
      axios
        .get(
          `https://backndVoo.voo-hub.com/api/ornization/news_feeds/item/${sendData}`,
          {
            headers: {
  ...
  const validateForm = () => {
    let formErrors = {};
    if (!content) formErrors.content = t("content");
  ...
  return (
    <div dir={isArabic ? "rtl" : "ltr"}>
      <ToastContainer />
      <AddAll name={edit ? t("EditFeeds") : t("AddFeeds")} navGo={-1} />
