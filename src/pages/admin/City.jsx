  ...
  const handleDelete = (userId, userName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://backndVoo.voo-hub.com/api/admin/city/delete/${userId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
    ...
    <div>
       <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-2'>
            ...
            <button onClick={() => navigate('/admin/addcity')} className='flex justify-center items-center bg-three py-1 px-2 rounded-[8px] gap-1'>
