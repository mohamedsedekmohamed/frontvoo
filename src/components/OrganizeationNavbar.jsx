...
const OrganizeationNavbar = ({ setIsOpen, isOpen }) => {
  ...
  useEffect(() => {
    const fetchCount = () => {
      axios
        .get(
          "https://backndVoo.voo-hub.com/api/ornization/noti/notification_num",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    <div className="w-full flex justify-between items-center relative">
      ...
      <div className="flex items-center gap-3 md:gap-5">
        <button
          ...
          className="hover:scale-110 transition-transform " // يمكن إخفاؤه في الشاشات الصغيرة جداً إن أردت
        >
