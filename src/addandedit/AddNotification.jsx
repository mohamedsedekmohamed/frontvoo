...
const AddNotification = () => {
  ...
  useEffect(() => {
    ...
    if (sendData) {
      ...
      axios
        .get(
          `https://backndVoo.voo-hub.com/api/admin/notification/item/${sendData}`,
          {
            headers: {
  ...
  const handleSave = () => {
    ...
    if (edit) {
      ...
      axios
        .post(
          `https://backndVoo.voo-hub.com/api/admin/notification/update/${sendData}`,
          newUseer,
          {
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    axios
      .post(
        "https://backndVoo.voo-hub.com/api/admin/notification/add",
        newUseer,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div>
      <ToastContainer />
      <AddAll
        name={edit ? "Edit Notification" : "Add Notification"}
        navGo={-1}
      />
