...
const Addorganizeation = () => {
  ...
  const handleChange = (e) => {
   ...
   const validateForm = () => {
    ...
    const handleSave = () => {
      ...
      if (edit) {
        axios.put(`https://backndVoo.voo-hub.com/api/admin/organization/update/${id}`, newUser, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
      ...
      axios.post('https://backndVoo.voo-hub.com/api/admin/organization/add', newUser, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <div>
    <ToastContainer/>
    <AddAll name={edit ? "Edit organization" : "Add organization"} navGo={-1} />
